...
@Component({
  selector: 'app-comment-audit-log',
  templateUrl: './comment-audit-log.component.html',
  styleUrls: ['./comment-audit-log.component.css']
})
export class CommentAuditLogComponent implements OnInit {
